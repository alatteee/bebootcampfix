  ...
  cors({
    ...
    origin: (origin, callback) => {
      ...
      const allowedOrigins = [
        `http://10.10.102.129:${port}`,
        `http://10.10.101.9:${port}`,
        `http://10.10.101.11:${port}`,
        `http://localhost:${port}`,
        "http://10.10.101.123:8000",
        "http://10.10.101.9:8000",
        "http://10.10.101.11:8000",
        "http://localhost:8000",
      ];
...
const options = {
  definition: {
    ...
    servers: [
      {
        url: "http://10.10.103.214:3001/api",
      },
    ],
    components: {
      securitySchemes: {
